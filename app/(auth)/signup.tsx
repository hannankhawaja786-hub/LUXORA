...
export default function SignupScreen() {
  ...
  const handleSignup = async () => {
    ...
    const { error: err } = await signUp({ email: email.trim(), password, full_name: fullName.trim() });
    if (err) setError(err);
  };
    ...
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>Join the luxury experience</Text>
          ...
          <TouchableOpacity style={styles.secondaryBtn} onPress={() => router.back()} disabled={isLoading}>
