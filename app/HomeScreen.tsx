...
const SERVICES = [
  ...
  { id: '8', label: 'CORPORATE', sub: 'Business Travel', dest: 'corporate' },
  { id: '9', label: 'GROUP TRIPS', sub: 'Plan Together', dest: 'groupPlanner' },
];
          ...
          <View style={styles.servicesGrid}>
            {SERVICES.map((item) => (
              <TouchableOpacity
                ...
                style={[
                  styles.srvCard,
                  (item.dest === 'weatherVisa' || item.dest === 'corporate' || item.dest === 'groupPlanner') && styles.srvCardWide,
                ]}
...
const styles = StyleSheet.create({
  ...
  navLabel: { fontSize: 8, letterSpacing: 2, color: GREY },
